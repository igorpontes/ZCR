<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="pesquisarprocessosdespesa.aspx.cs" Inherits="GED_TCESE.WebForm5" Title="Tribunal de Contas do Estados de Sergipe - Gestão Eletrônica de Documentos" EnableEventValidation="true"%>
            ...
            <tr>
                <td >
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                        AutoGenerateColumns="False" CellPadding="10" ForeColor="#4E7C3B" GridLines="None" 
                        Height="85%" Width="100%" AllowSorting="True"
                        ShowFooter="True" onrowcommand="GridView1_RowCommand1" DataKeyNames="id" onpageindexchanging="GridView1_PageIndexChanging" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="documento1" HeaderText="Número processo" 
                                SortExpression="documento1" />
                            <asp:BoundField DataField="documento2" HeaderText="Ano processo" 
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSourceLBW" runat="server" 
                        SelectMethod="PesquisarCampos" TypeName="GED_TCESE.AdaptadorDespesa">
                        <SelectParameters>
