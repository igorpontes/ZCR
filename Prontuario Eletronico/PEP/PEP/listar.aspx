<%@ Page Language="C#" MasterPageFile="~/Site_Master.Master" AutoEventWireup="true" CodeBehind="listar.aspx.cs" Inherits="PEP.WebForm9" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: 400px; width: 197%;">
        <table width="100%">
            <tr>
            ...
            <tr>
                <td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        CellPadding="3" ForeColor="#4E7C3B" 
                        GridLines="None" Height="75%" Width="100%" AllowPaging="True" 
                        onrowcommand="GridView1_RowCommand" 
                        HorizontalAlign="Center" AllowSorting="True" 
                        onsorting="GridView1_Sorting1" 
                        onpageindexchanging="GridView1_PageIndexChanging" style="margin-top: 46px; margin-left: 0px;" 
                        DataKeyNames="id">
