<%@ Page Language="C#" MasterPageFile="~/Site_Master.Master" AutoEventWireup="true" CodeBehind="alterarpaciente.aspx.cs" Inherits="PEP.WebForm10" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="estilo.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin-top: 65px; height: 535px;">
        <asp:Panel ID="panelCentral" runat="server" CssClass="alteraPaciente" Height="516px" Width="1221px" DefaultButton="ImageButtonAlterar">
            <fieldset id="Fieldset" class="fieldsetAlterar">
                ...
                <table align="center" border="0px" cellpadding="0px" cellspacing="0px" 
	                ...
	                <tr>
	                    <td class="tdDefault" colspan="4" align="center">
	                        ...
	                        <asp:Label ID="LabelErro" runat="server" Text="" Font-Bold="true" ForeColor="Red"></asp:Label>
	                ...
	                <tr>
		                ...
		                <td class="tdDefault">
			                <asp:TextBox ID="TextBoxNumero_Registro" runat="server" BackColor="#FFFFFF" 
				                Width="250px" TabIndex="1" ReadOnly=true></asp:TextBox>
		                </td>
	                </tr>
	                <tr>
                    ...
                    <tr>
                        ...
                        <td align="center" class="tdDefault" colspan="2">
                            <asp:ImageButton ID="ImageButtonAlterar" runat="server" 
                                ImageUrl="~/imagens/botao_Enviar.png" onclick="ImageButtonAlterar_Click" 
                                TabIndex="33" />
                        </td>
                        <td class="tdDefault">
                        </td>
