...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    <br />
    <center>
        <div id="TopPesquisa" class="CornerTop" data-corner="top 10px">
        ...
        <div id="DownPesquisa" class="CornerDown" data-corner="bottom 10px">
                                ...
                                <EmptyDataTemplate>
                                    <table>
                                        <tr valign="middle">
                                            ...
                                            <td valign="middle">
                                                <asp:Label ID="LabelGridVazio" runat="server" Text="Não foram encontrados resultados!"
