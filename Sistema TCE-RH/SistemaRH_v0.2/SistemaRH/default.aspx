<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SistemaRH.Default" Title="Untitled Page" %>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <asp:ImageButton ID="ImageButtonEnviar" runat="server" 
                                ImageUrl="~/imagens/botao_Enviar.png" />
                        </td>
                    </tr>
                    <tr>
                        <td>
